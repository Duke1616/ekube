...
const (
	RPC_ListCluster_FullMethodName     = "/ekube.cluster.v1.RPC/ListCluster"
	RPC_DescribeCluster_FullMethodName = "/ekube.cluster.v1.RPC/DescribeCluster"
)
...
type RPCClient interface {
	// 查询集群列表
	ListCluster(ctx context.Context, in *ListClusterRequest, opts ...grpc.CallOption) (*ClusterSet, error)
	// 查询集群详情
...
func (c *rPCClient) ListCluster(ctx context.Context, in *ListClusterRequest, opts ...grpc.CallOption) (*ClusterSet, error) {
	out := new(ClusterSet)
	err := c.cc.Invoke(ctx, RPC_ListCluster_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RPCServer interface {
	// 查询集群列表
	ListCluster(context.Context, *ListClusterRequest) (*ClusterSet, error)
	// 查询集群详情
...
func (UnimplementedRPCServer) ListCluster(context.Context, *ListClusterRequest) (*ClusterSet, error) {
...
func _RPC_ListCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RPCServer).ListCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPC_ListCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCServer).ListCluster(ctx, req.(*ListClusterRequest))
	}
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ekube.cluster.v1.RPC",
	HandlerType: (*RPCServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListCluster",
			Handler:    _RPC_ListCluster_Handler,
		},
		{
	...
	Metadata: "pb/cluster/v1/rpc.proto",
}
